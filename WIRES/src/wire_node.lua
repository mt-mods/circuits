...
for k, color in ipairs({ "red", "green", "blue" }) do
	...
	def.connects_to =
		{ "group:circuit_raw_wire", "group:circuit_wire_" .. color, "group:circuit_consumer", "group:circuit_power" }
	def.circuits.connects_to = { "circuit_raw_wire", "circuit_wire_" .. color, "circuit_consumer", "circuit_power" }
